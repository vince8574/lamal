<div @class([
    ...
    <div class="w-full flex justify-end">
        <a wire:click="createProfile"
            class='rounded-[10px] bg-[#FF87AB] w-[343px] h-auto py-[18px] px-[17px] text-center justify-center flex items-center justify-center font-bold text-[20px] gap-4 cursor-pointer'>
            Comparer
