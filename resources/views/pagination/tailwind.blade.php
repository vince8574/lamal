    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex items-center justify-between">
        <div class="flex justify-between flex-1 sm:hidden">
            @if ($paginator->onFirstPage())
                <span
                    class="relative bg-[gray-200] inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-[#E0E0E0] rounded-[10px] cursor-default leading-5 rounded-md dark:text-gray-600 dark:bg-gray-800 dark:border-gray-600">
                    ...
                    <span class="relative z-0 inline-flex rtl:flex-row-reverse shadow-sm rounded-md">
                            ...
                            @if (is_array($element))
                                @foreach ($element as $page => $url)
                                    ...
                                    @elseif($page == 4 || $page == $paginator->lastPage() - 3)
                                        ...
                                        <span
                                            class="px-4 py-2 text-gray-500 bg-white border border-[#E0E0E0]">...</span>
                                    @endif
                                @endforeach
                            @endif
                        @endforeach
                        ...
                        @else
                            <span aria-disabled="true" aria-label="{{ __('pagination.next') }}">
                                <span
                                    class="relative inline-flex items-center px-2 py-2 -ml-px text-sm font-medium text-gray-500 bg-white border border-[#E0E0E0] cursor-default rounded-r-md leading-5 dark:bg-gray-800 dark:border-gray-600"
                                    aria-hidden="true">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                                            d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z"
