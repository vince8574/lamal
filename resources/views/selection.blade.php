<x-layouts.page>
    <div class="flex flex-col m-auto gap-8 md:gap-16 px-4 sm:px-8 md:px-16 w-full max-w-full overflow-hidden">
        ...
        <div class='flex flex-row w-full md:mx-0 lg:mx-0'>
            <div class='w-fit'>
                <a href="{{ route('search') }}"
                    class='ml-0 bg-customWhite flex items-center justify-center rounded-[10px] gap-2 sm:gap-4 font-roboto text-[14px] sm:text-[16px] text-customBlack px-3 sm:px-4 py-2'><img
                ...
                <div id="content" class='flex flex-col w-full md:mx-0 lg:mx-0 mb-8'>
                    <div class="flex flex-row rounded-t-[10px]">
                        <div class="flex flex-col w-fit min-w-16 sm:min-w-24 ml-0 pb-2 sm:pb-3">
                            <span
                                class="font-poetsen text-customYellow text-[22px] sm:text-[26px] md:text-[30px] capitalize">{{ $profile->name }}</span>
                        </div>
                    </div>
