...
<body>
    <div class="flex flex-nowrap">
        ...
        <div id="content" class='bg-[#E6F1FA] w-3/4 flex flex-wrap items-center'>
            ...
            <div class="w-3/5 m-auto flex flex-wrap gap-2 p-4 rounded-xl mt-4">
                @foreach ($primes as $prime)
                <div class="mt-4 flex flex-col m-auto rounded-xl border-2 border-black m-2/5 grow text-center rounded-xl bg-white">
                    ...
                    @endif
                    <label>Nom du tarif: {{$prime->tarif_name}}</label>
                </div>
                @endforeach
                <div class='w-full justify-between font-bold'>
                    {{$primes->links()}}
                </div>
            </div>
        </div>
