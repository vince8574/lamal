...
<body class="bg-[#3B7080] font-roboto min-h-screen flex px-32">
    <div class='flex flex-col gap-8 m-auto'>
        ...
        <button class='rounded-[10px] bg-[#FF87AB] w-[343px] h-[108px] py-[24px] px-[17px] text-center justify-center flex items-center m-auto font-bold text-[20px] gap-4'>Comparer les primes<img src="{{ asset('images/svg/right-arrow.svg') }}" alt="Right Arrow" class="w-4 h-4"></button>
